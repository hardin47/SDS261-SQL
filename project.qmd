...
You might think about web scraping to retrieve data (probably using the **rvest** R package).  For example, you might scrape every <a href = "https://en.wikipedia.org/wiki/List_of_songs_by_Taylor_Swift" target = "_blank">Taylor Swift song</a> and use regular expressions to format the information in a way that allows easy question asking.
