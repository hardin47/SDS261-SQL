...
include_graphics("images/git-workflow-nogradescope.png")
```
...
1. The first step is to install R + RStudio + Git on your machine.  (If you are planning to use Smith's RStudio server, R + RStudio + Git are all three already installed for you.)
...
The lab assignments will be individual assignments.
The project will be a paired or an individual assignment.
