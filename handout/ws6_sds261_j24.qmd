...
* The combination of donor, organ, and patient uniquely identifies a record * `PRIMARY KEY`(s) and FOREIGN KEY`(s) should be identified.
* Each record must have a treatment `price` that is bigger than 0 and smaller than 1,000,000 dollar.
