...
Example: Let's say that I want to test whether the string contains a US zip code (of the format: xxxxx-xxxx).  I might want to test it against a particular string.
