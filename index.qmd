...
schedule <- tribble(
  ...
  '{{< fa book-open >}} <a href="https://st47s.com/SDS261/Notes/p1-intro-to-sql.html" target = "_blank">Introduction</a> <br> <i class="fas fa-book-open"></i> {{< fa book-open >}} <a href="https://mdsr-book.github.io/mdsr3e/15-sqlI.html#sec-dplyr-sql" target = "_blank"> MDSR 15.1</a> <br> {{< fa book-open >}} <a href="https://r4ds.hadley.nz/databases.html#database-basics" target = "_blank"> R4DS 21.2</a> <br> {{< fa desktop >}} <a href="https://sds261-sql.netlify.app/slides/2024-01-08-db.html" target = "_blank"> What is a DB?</a> <br> {{< fa pencil >}} <a href="https://sds261-sql.netlify.app/handouts/ws1_sds261_j24.pdf" target = "_blank">WS 1</a>',
  '{{< fa code >}} <a href="https://sds261-sql.netlify.app/handouts/lab1_db_sds261_j24.pdf" target = "_blank">Lab 1</a>',
  ...
  '',
  'email prof with dataset idea for <a href="https://sds261-sql.netlify.app/project" target = "_blank"><i class="fas fa-pencil-alt"></i>project</a> <br> {{< fa code >}} <a href="" target = "_blank">Lab 5</a>',
  '',
